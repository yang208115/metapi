...
const zhToEn: Record<string, string> = {
  ...
  '统一管理 OpenAI、Claude、Gemini 上游，自动发现模型并智能路由。': 'Manage OpenAI, Claude, and Gemini upstreams with automatic model discovery and smart routing.',
  '支持 OpenAI / Claude / Gemini': 'Supports OpenAI / Claude / Gemini',
  '用户名': 'Username',
  '取消': 'Cancel',
  '保存': 'Save',
  '关闭': 'Close',
  ...
  '使用日志': 'Usage Logs',
  '终端日志': 'Terminal Logs',
  '实时查看当前 Metapi 进程的控制台与服务请求日志': 'View console and service request logs from the current Metapi process in real time',
  '实时连接': 'Live',
  '正在连接': 'Connecting',
  '正在重连': 'Reconnecting',
  '日志连接已断开': 'Log connection closed',
  '正在自动重连': 'reconnecting automatically',
  '清空当前视图': 'Clear View',
  '下载日志': 'Download Logs',
  '搜索日志内容...': 'Search log messages...',
  '搜索日志内容': 'Search log messages',
  '日志级别筛选': 'Log level filters',
  '自动跟随': 'Auto-follow',
  '等待终端日志...': 'Waiting for terminal logs...',
  '没有匹配的日志': 'No matching logs',
  '新日志会实时显示在这里': 'New logs will appear here in real time',
  '请调整关键词或日志级别': 'Adjust the keyword or log level filters',
  '仅保留当前进程最近 1000 条日志；重启服务后会清空，不会写入数据库。': 'Only the latest 1,000 logs from this process are kept. They are cleared on restart and are not stored in the database.',
  '暂无使用日志': 'No Usage Logs',
  '最终失败': 'Final Failure',
  '此请求未记录完整链路（未开启或未捕获逐次尝试追踪，仅显示最终结果）': 'Complete trace not recorded for this request (debug tracing not enabled or attempt history unavailable; showing final outcome only)',
  '系统': 'System',
  '设置': 'Settings',
  '程序日志': 'System Logs',
  '导入/导出': 'Import/Export',
  ...
  '正在加载模型信息...': 'Loading pricing metadata...',
  ...
  '核心目标：按需模型发现、自动路由重建、统一代理可观测性。': 'Core goals: on-demand model discovery, automatic route rebuild, and unified proxy observability.',
