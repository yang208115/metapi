...
const zhToEn: Record<string, string> = {
  ...
  // About page
  '将 OpenAI、Claude、Gemini 连接聚合为统一网关。一个 API Key、一个入口，集中管理模型和路由。': 'Aggregate OpenAI, Claude, and Gemini connections behind one gateway with centralized model and route management.',
  '核心特色': 'Key Features',
  ...
  '集中管理 OpenAI / Claude / Gemini': 'Centrally manage OpenAI / Claude / Gemini',
  ...
  '跨站模型覆盖、延迟与成功率实测数据': 'Cross-site model coverage, latency, and success rate metrics',
