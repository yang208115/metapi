...
**Recommendation** / **建议**: Always use the latest stable release from [GitHub Releases](https://github.com/yang208115/metapi/releases) or the `main` branch for the most up-to-date security patches.

始终使用 [GitHub Releases](https://github.com/yang208115/metapi/releases) 的最新稳定版本或 `main` 分支以获得最新的安全补丁。
...
1. **GitHub Security Advisory** (Preferred) / **GitHub 安全公告**（首选）
   - Go to: https://github.com/yang208115/metapi/security/advisories/new
...
- [GitHub Security Advisories](https://github.com/yang208115/metapi/security/advisories)
- [GitHub Releases](https://github.com/yang208115/metapi/releases) with `[SECURITY]` tag / 带有 `[SECURITY]` 标签
