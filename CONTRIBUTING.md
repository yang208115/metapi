...
Metapi is a unified proxy and routing layer for OpenAI, Claude, and Gemini connections.

Metapi 是面向 OpenAI、Claude、Gemini 连接的统一代理与路由层。
...
Examples / 示例:
```
feat: add Gemini connection support
